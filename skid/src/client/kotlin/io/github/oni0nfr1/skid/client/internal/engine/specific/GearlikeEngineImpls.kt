...
internal class GearEngineImpl(kart: Kart<GearEngine, GearTachometer>) :
    KartEngineImpl<GearEngine, GearTachometer>(kart), GearEngine

internal class F1EngineImpl(kart: Kart<F1Engine, F1Tachometer>) :
    KartEngineImpl<F1Engine, F1Tachometer>(kart), F1Engine

internal class RallyEngineImpl(kart: Kart<RallyEngine, RallyTachometer>) :
